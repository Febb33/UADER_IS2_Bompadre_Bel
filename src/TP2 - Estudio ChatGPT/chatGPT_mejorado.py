...
def invocar_chatgpt(prompt):
    """
    Simula una llamada al API de ChatGPT. En un caso real, esta función
    debería hacer una solicitud HTTP con autenticación a OpenAI.
    """
    try:
...
def main():
    ...
    Permite al usuario ingresar consultas que son enviadas (simuladamente) a ChatGPT.
    Admite uso de flecha ↑ para reutilizar la última consulta.
    """
